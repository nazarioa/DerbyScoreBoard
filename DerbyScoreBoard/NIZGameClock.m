...
@interface NIZGameClock() 
    ...
    //@property id<NIZGameClockDelegate> delegate;
...
@implementation NIZGameClock
    ...
    - (void)updateCounter:(NSTimer *)theTimer {
        if(self.secondsLeft > 0 ){
            ...
            //return ;
            //[_delegate NIZclockUpdate: [NSString stringWithFormat:@"%02d:%02d:%02d", self.hours, self.minutes, self.seconds]];
            //[self.delegate NIZclockUpdate:@"SPANKPANTS"];
